...
public class StreamsBackport implements Backport {
    ...
    private static void mapTypes(final @NotNull TypeMap map) {
        // java.lang
        map.put("java/lang/FunctionalInterface", "java9/lang/FunctionalInterface");

        // java.util
        map.put("java/util/DoubleSummaryStatistics", "java9/util/DoubleSummaryStatistics");
        map.put("java/util/IntSummaryStatistics", "java9/util/IntSummaryStatistics");
        map.put("java/util/LongSummaryStatistics", "java9/util/LongSummaryStatistics");
        ...
        map.put("java/util/SplittableRandom", "java9/util/SplittableRandom");
        map.putPrefix("java/util/Spliterator", "java9/util/Spliterator");
        map.put("java/util/StringJoiner", "java9/util/StringJoiner");

        // java.util.concurrent
        map.put("java/util/concurrent/CountedCompleter", "java9/util/concurrent/CountedCompleter");
        map.put("java/util/concurrent/ForkJoinPool", "java9/util/concurrent/ForkJoinPool");
        map.put("java/util/concurrent/ForkJoinTask", "java9/util/concurrent/ForkJoinTask");
        map.put("java/util/concurrent/ForkJoinWorkerTask", "java9/util/concurrent/ForkJoinWorkerTask");
        map.put("java/util/concurrent/RecursiveAction", "java9/util/concurrent/RecursiveAction");
        map.put("java/util/concurrent/RecursiveTask", "java9/util/concurrent/RecursiveTask");
        map.put("java/util/concurrent/ThreadLocalRandom", "java9/util/concurrent/ThreadLocalRandom");
    ...
    private static void mapMethods(final @NotNull MethodMap map) {
